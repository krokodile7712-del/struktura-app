...
const styles = StyleSheet.create({
  ...
  tourBtnFloat: { position: 'absolute', top: 10, right: 16, zIndex: 20, width: 32, height: 32, borderRadius: 16, backgroundColor: colors.surface2, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center' },
