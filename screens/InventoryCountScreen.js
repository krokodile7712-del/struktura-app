...
const styles = StyleSheet.create({
  ...
  itemRowSurplus:  { backgroundColor: 'rgba(123,175,142,0.06)' },
  itemLeft: { flex: 1 },
  ...
  actualInput: { width: 60, padding: 7, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: 10, color: colors.text, fontSize: 15, fontFamily: fonts.family, textAlign: 'center' },
  actualInputFilled: { borderColor: 'rgba(240,160,80,0.5)' },
  ...
  modalInner: { width: '62%', maxWidth: 580, backgroundColor: colors.surface, borderRadius: 20, padding: 24, borderWidth: 1, borderColor: colors.borderHi },
  ...
  summaryCell: { flex: 1, backgroundColor: colors.surface, borderRadius: 12, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: colors.border },
