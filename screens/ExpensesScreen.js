    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView style={styles.screen} contentContainerStyle={styles.inner}>
        <MetalCard>
          ...
          <Text style={styles.sectionTitle}>Фильтр</Text>
          <View style={styles.chipsRow}>
            <Pressable style={[styles.chip, !filterCategory && styles.chipActive]} onPress={() => setFilterCategory(null)}>
              <Text style={[styles.chipLabel, !filterCategory && styles.chipLabelActive]}>Все</Text>
            </Pressable>
            {CATEGORIES.map(cat => (
              <Pressable key={cat} style={[styles.chip, filterCategory === cat && styles.chipActive]} onPress={() => setFilterCategory(cat)}>
