...
const styles = StyleSheet.create({
  ...
  catHead:  { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 14, backgroundColor: colors.surface, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(64,60,55,0.3)', marginBottom: 6 },
  ...
  groupCard:{ backgroundColor: colors.surface, borderRadius: 14, borderWidth: 1, borderColor: 'rgba(64,60,55,0.3)', overflow: 'hidden', marginBottom: 4 },
  cardRow:  { flexDirection: 'row', alignItems: 'center', paddingVertical: 13, paddingHorizontal: 14 },
  rowDiv:   { borderBottomWidth: 1, borderBottomColor: 'rgba(64,60,55,0.2)' },
  card: { backgroundColor: colors.surface, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(64,60,55,0.3)', marginBottom: 10, overflow: 'hidden' },
  ...
  ingList: { borderTopWidth: 1, borderTopColor: 'rgba(64,60,55,0.2)' },
  ingRow:  { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, paddingHorizontal: 14, gap: 8 },
  ingDiv:  { borderBottomWidth: 1, borderBottomColor: 'rgba(64,60,55,0.15)' },
  ...
  editIngRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(64,60,55,0.2)' },
  ingInput:  { width: 80, padding: 8, backgroundColor: colors.surface, borderWidth: 1, borderColor: 'rgba(64,60,55,0.4)', borderRadius: 10, color: colors.text, fontFamily: fonts.family, fontSize: 14, textAlign: 'center' },

  addIngBtn: { paddingVertical: 14, alignItems: 'center', borderTopWidth: 1, borderTopColor: 'rgba(64,60,55,0.2)', marginTop: 8 },
  ...
  modalHeader: { flexDirection: 'row', alignItems: 'center', padding: 18, borderBottomWidth: 1, borderBottomColor: 'rgba(64,60,55,0.3)' },
  ...
  closeBtn: { width: 28, height: 28, borderRadius: 14, backgroundColor: 'rgba(64,60,55,0.25)', alignItems: 'center', justifyContent: 'center', marginLeft: 8 },
