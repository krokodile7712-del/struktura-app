...
const styles = StyleSheet.create({
  ...
  modalInner: { width: '50%', maxWidth: 480, maxHeight: '88%', backgroundColor: colors.surface, borderRadius: 20, padding: 22, borderWidth: 1, borderColor: 'rgba(64,60,55,0.5)' },
  ...
  curBox:    { padding: 16, backgroundColor: colors.surface, borderRadius: 14, borderWidth: 1, borderColor: colors.border, marginBottom: 16 },
  ...
  modeRow:    { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, paddingHorizontal: 16, backgroundColor: colors.surface },
  ...
  confirmBtnOff: { backgroundColor: 'rgba(64,60,55,0.3)' },
  ...
  histRow:    { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 7, borderBottomWidth: 1, borderBottomColor: 'rgba(64,60,55,0.15)' },
