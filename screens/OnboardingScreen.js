      ...
      if (sessionUser) {
        ...
        if (empName.trim() && empPin.length >= 4) {
          Alert.alert(
            ...
            'Похоже, указанный PIN уже используется существующим сотрудником в базе. Войдите под тем PIN, что реально сработает, или задайте другой PIN и попробуйте снова через Настройки → Сотрудники.'
          );
        }
