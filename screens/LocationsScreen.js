...
export default function LocationsScreen({ navigation }) {
  ...
  const tourSteps = [
    { key: 'locations.list',   title: 'Список точек', text: 'Тап по карточке выбирает активную точку — она используется в кассе при списании ингредиентов и на Складе при просмотре остатков. Выбор сбрасывается при перезапуске приложения — если работаете с нескольких точек, проверяйте, что выбрана нужная.' },
