...
const styles = StyleSheet.create({
  ...
  // Левая панель
  left:   { flex: 1, backgroundColor: colors.surface2 },
  ...
  catBtn: { width: 46, height: 46, borderRadius: 10, backgroundColor: colors.surface3, borderWidth: 1, borderColor: colors.borderHi, alignItems: 'center', justifyContent: 'center' },
  ...
  productRow:    { flexDirection: 'row', alignItems: 'center', paddingVertical: 15, paddingHorizontal: 14, position: 'relative' },
  productRowDiv: { borderBottomWidth: 1, borderBottomColor: colors.borderHi },
  ...
  productName:   { fontFamily: fonts.family, fontSize: 16, fontWeight: '700', color: colors.text },
  productNameActive: { color: colors.orange },
  productPrice:  { fontFamily: fonts.family, fontSize: 15, fontWeight: '800', color: colors.orange, marginTop: 2, marginRight: 6 },
